        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button class="btn btn-rounded-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLongScollable"><i data-feather="plus"></i></button>
                </div>
                    ...
                    if (galary.length > 0) {
                        $.each(galary, function(index, bank) {
                            ...
                            tr.innerHTML = `
                                    ...
                                    <td>
                                       <a href="#" class="btn btn-primary btn-icon galary_edit" data-id=${bank.id} data-bs-toggle="modal" data-bs-target="#edit">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                           <a href="#" class="btn btn-danger btn-icon galary_delete" data-id=${bank.id}>
                ...
                success: function(data) {
                    ...
                    if (data.galary.url) {
                        $('.showEditImage').attr('src',
                            'http://127.0.0.1:8000/uploads/brand/' + data.galary.url);
                    } else {
                        $('.showEditImage').attr('src',
