...
<header class="main-header header-style-one">
        ...
        <div class="container">
            <div class="outer-box clearfix">
                ...
                <div class="header-left clearfix pull-left">
                    <div class="logo">
                        <a href="#"><img src="{{asset('frontend')}}/assets/images/resources/logo.png" class="img-fluid img_size" height="100" width="100" alt="Awesome Logo" title=""></a>
                    </div>
                </div>
                <!--End Header Left-->
                <!--Start Header Right-->
                    ...
                    <div class="bottom clearfix">
                        <div class="left pull-left">
                            <ul class="header-menu">
                                <li><a href="#">Help Desk<i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
                                <li><a href="#">Get A Free Quote<i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
                                <li><a href="#">Our Onlilne Shop<i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
        ...
        <div class="container">
            <div class="clearfix">
                ...
                <div class="logo float-left">
                    <a href="#" class="img-responsive img-fluid"><img src="{{asset('frontend')}}/assets/images/resources/sticky-logo.png" height="100" width="100" alt="" title=""></a>
                </div>
                <!--Right Col-->
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="#"><img src="{{asset('frontend')}}/assets/images/resources/logo.png" alt="" title=""></a></div>
